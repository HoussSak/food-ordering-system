...
@Slf4j
@Component
public class CancelOrderKafkaMessagingPublisher implements OrderCancelledPaymentRequestMessagePublisher {
    ...
    public CancelOrderKafkaMessagingPublisher(OrderMessagingDataMapper orderMessagingDataMapper,
    ...
    public void publish(OrderCancelledEvent domainEvent) {
        ...
        try {
            ...
            log.error("Error while sending PaymentRequestAvroModel message"+
                    " to kafka with id: {} error: {}",orderId,e.getMessage());
