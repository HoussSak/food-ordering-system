...
import com.food.odrering.system.order.service.domain.OrderDomainService;
...
public class OrderCreateCommandHandler {
    ...
    public CreateOrderResponse createOrder(CreateOrderCommand createOrderCommand) {
        ...
        OrderCreatedEvent orderCreatedEvent =  orderDomainService.validateAndInitiateEvent(order,restaurant);
